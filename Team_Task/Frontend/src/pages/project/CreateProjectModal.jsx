import { Dialog, DialogTitle, DialogContent, DialogActions, TextField, Select, MenuItem, Stack, FormControl, FormLabel, Box, Typography } from "@mui/material";
...
const CreateProjectModal = ({ open, handleClose, setSuccessOpen }) => {
        ...
        <Dialog open={open} onClose={handleClose} fullWidth maxWidth="sm">
            <Box sx={{ padding: 2 }}>
                ...
                <DialogActions>
                    ...
                    <MyButton handler={handleCreateProject} name="Create" />
                </DialogActions>
            </Box>
        </Dialog>
    );

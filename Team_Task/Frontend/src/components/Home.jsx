    ...
    <>
      <Box>
        ...
        >
          <Box className='home-left'>
            <Typography variant="h3" color="initial" className='home-left-heading'>Streamlined Task Management for Teams and Individuals</Typography>
            <Typography variant="body1" color="initial" className='home-left-body'>In today's fast-paced world, staying organized and on track can be challenging, whether you are working alone or part of a team.</Typography>
          </Box>
          <Box className='home-right'>
          </Box>
        </Stack>

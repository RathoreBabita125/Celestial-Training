...
import { type Resolvable } from '../../src/utils/resolvable.ts';
...
import type { ExecuteOperationOptions, LegacyExperimentalExecuteIncrementally, VariableValues } from '../../src/externalTypes/graphql.ts';
import type { ApolloConfig, ApolloServerOptions, ApolloServerPlugin, BaseContext, ContextThunk, DocumentStore, GraphQLRequest, GraphQLResponse, HTTPGraphQLHead, HTTPGraphQLRequest, HTTPGraphQLResponse, LandingPage, PersistedQueryOptions } from '../../src/externalTypes/index.ts';
import type { GraphQLExperimentalIncrementalExecutionResultsAlpha2, GraphQLExperimentalIncrementalExecutionResultsAlpha9 } from '../../src/incrementalDeliveryPolyfill.ts';
import { SchemaManager } from '../../src/utils/schemaManager.ts';
